...
const CheckoutSuccess = ({ placedOrderId, email, name, address, city, paymentMethod = 'card', onTrack, onGoHome }) => {
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-20 text-center space-y-6 animate-fadeIn">
      ...
      <div className="space-y-3">
        <button
          onClick={onTrack}
          className="w-full rounded-xl bg-indigo-600 py-3 text-sm font-semibold text-white hover:bg-indigo-700 shadow-md transition-transform active:scale-95 cursor-pointer"
        >
